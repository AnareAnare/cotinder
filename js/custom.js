...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById('slots') && document.querySelectorAll('.slot').length) {
    ...
    const deleteButtons = document.querySelectorAll('.pet-delete');
    if(deleteButtons.length) {
        $('.pet-delete').on('click', function(e) {
            let parent = e.currentTarget.closest('.pet-item__top');
            let block = parent.querySelector('.delete-alert').classList.add('delete-alert__active');
        });
        $('.petDelete').on('click', function(e) {
            e.currentTarget.closest('.pet-item').remove();
        });
        $('.petNotDelete').on('click', function(e) {
            let parent = e.currentTarget.closest('.pet-item__top');
            parent.querySelector('.delete-alert').classList.remove('delete-alert__active');
        });
    }
});